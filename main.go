...
func main() {
	...
	adminGrp.GET("/table/pembayaran", handlers.AdminTablePembayaran)
	adminGrp.GET("/table/sls", handlers.AdminTableSLS)
	adminGrp.GET("/table/listing", handlers.AdminTableListing)
	...
	adminGrp.GET("/table/anomali-custom", handlers.AdminAnomaliCustomTable)
	...
	adminGrp.GET("/table/keberadaan-usaha-keseluruhan", handlers.AdminKeberadaanUsahaKeseluruhanTable)
	...
	adminGrp.GET("/download/listing", handlers.DownloadListing)
	adminGrp.GET("/download/organik", handlers.DownloadOrganik)
	adminGrp.GET("/download/anomali", handlers.DownloadAnomali)
	adminGrp.GET("/download/anomali-custom", handlers.DownloadAnomaliCustom)
	...
	adminGrp.GET("/download/keberadaan-usaha-keseluruhan", handlers.DownloadKeberadaanUsahaKeseluruhan)
	...
	orgGrp.GET("/table/tidak-ditemukan", handlers.OrganikTidakDitemukanTable)
	orgGrp.GET("/table/tidak-ditemukan-rekap", handlers.OrganikTidakDitemukanRekapTable)
